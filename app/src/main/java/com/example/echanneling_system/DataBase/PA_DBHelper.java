...
public class PA_DBHelper extends SQLiteOpenHelper {
    ...
    public long addappointment(String p_name1,String p_age1,String p_nic1,String p_phone1,String p_date1){
    ...
    //add new payment
    public long appointmentpayment(String pcardno ,String cvvno ,String expiredate){
